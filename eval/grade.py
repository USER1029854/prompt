...
MATCH = {
 ...
 "case-12": [["governor","governance role","role manager","admin role","add strategy","addstrategy","set allocation","migrate","force-revoke","debt","reallocat","authority"],
             ["cost to acquire","price to acquire","deposit-to-votes","deposit buys","shares that wrap","fraction of tvl","cheap to control","thin float","tiny float","controlling share for"],
             ...
             ["warp past","fork poc","proof of concept","contingent on the veto","queued a","executed the drain","net positive","demonstrated the drain"]],
